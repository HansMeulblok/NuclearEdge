...
public class PlayerMovement : MonoBehaviour
{
    ...
    void CheckColision()
    {
        ...
        if (Physics.BoxCast(transform.position, Vector3.one * 0.49f, Vector3.left, transform.rotation, colisionDistance))
        {
            leftCol = true;
        }
        else
        ...
        if (Physics.BoxCast(transform.position, Vector3.one * 0.49f, Vector3.right, transform.rotation, colisionDistance))
        {
            rightCol = true;
        }
        else
        ...
        if (Physics.BoxCast(transform.position, Vector3.one * 0.49f, Vector3.down, transform.rotation, colisionDistance))
        {
            grounded = true;
        }
        else
