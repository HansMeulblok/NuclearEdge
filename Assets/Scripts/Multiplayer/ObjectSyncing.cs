...
public class ObjectSyncing : MonoBehaviourPunCallbacks, IPunObservable
{
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        else
        {
            ...
            if (syncPosition)
            {
                ...
                objectRB.velocity = (Vector2)stream.ReceiveNext(); networkPosition += objectRB.velocity * lag;
            }
    ...
    private void FixedUpdate()
    {
        ...
        {
            if (syncPosition) { objectRB.position = Vector2.MoveTowards(objectRB.position, networkPosition, Time.fixedDeltaTime); }
